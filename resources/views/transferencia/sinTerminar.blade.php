                    ...
                    <table id="tabla-data" class="table">
                        ...
                        @foreach ($solicitudes as $index => $item)
                            ...
                            @endphp
                                ...
                                <td>
                                    <button type="button" data-toggle="tooltip" class="btn btn-dark btn-sm" title="Continuar ingreso de solicitud donde había quedado" onclick="location.href='{{route('transferencia.continuarSolicitud', ['id' => $item->id,'reingresa'=> 0,'acceso'=>'ingreso'])}} '">
    ...
    <script>
        $(function () {
          function createTooltip(element) {
            ...
            tooltip.innerHTML = '<div class="tooltip-arrow"></div><div class="tooltip-inner">' + element.getAttribute("data-original-title") + "</div>";
