<header class="navbar navbar-fixed-top bg-light">
    ...
    <ul class="nav navbar-nav navbar-right">
        <!--<li class="dropdown dropdown-item-slide">
            ...
            <a href="#" class="dropdown-toggle pl10 pr10" data-toggle="dropdown" > 
                <i class="fa fa-bell fs22 text-warning"></i>
            ...
            <ul class="dropdown-menu dropdown-hover dropdown-persist pn w350 bg-white animated animated-shorter fadeIn" role="menu">
                ...
                <li class="p10 br-t item-1">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="{{asset("assets/$themes/img/avatars/2.jpg")}}" class="mw40" alt="holder-img"> </a>
                ...
                <li class="p10 br-t item-2">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="{{asset("assets/$themes/img/avatars/3.jpg")}}" class="mw40" alt="holder-img"> </a>
                        <div class="media-body va-m">
                            <h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
                            <a class="text-system" href="#"> Max </a>
                        </div>
                ...
                <li class="p10 br-t item-3">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="{{asset("assets/$themes/img/avatars/4.jpg")}}" class="mw40" alt="holder-img"> </a>
                        <div class="media-body va-m">
                            <h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
                            <a class="text-system" href="#"> Max </a>
                        </div>
                ...
                <li class="p10 br-t item-4">
                    <div class="media">
                        <a class="media-left" href="#"> <img src="{{asset("assets/$themes/img/avatars/5.jpg")}}" class="mw40" alt="holder-img"> </a>
                        <div class="media-body va-m">
                            <h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
                            <a class="text-system" href="#"> Max </a>
                        </div>
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="{{asset("assets/$themes/img/avatars/placeholder.png")}}" alt="avatar" class="mw30 br64 mr15">
