...
<div class="panel panel-info panel-border top">
    <div class="panel-heading">
        <span class="panel-title">Listado de Tipos de Documento</span>
        <div class="widget-menu pull-right">
            <a href="{{route('tipo_documento.create')}}" class="btn btn-info btn-sm"><li class="fa fa-plus"></li> Agregar Tipo de Documento</a>
        </div>
    </div>
                    ...
                    <table id="tabla-data" class="table table-bordered">
                        ...
                        @foreach ($tipo_documentos as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('tipo_documento.destroy', ['id' => $item->id])}}" class="form-eliminar" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-system btn-sm" onclick="location.href='{{route('tipo_documento.edit', ['id' => $item->id])}}'">
