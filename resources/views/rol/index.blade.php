...
<div class="panel panel-info panel-border top">
    <div class="panel-heading">
        <span class="panel-title">Listado de Roles</span>
        <div class="widget-menu pull-right">
            <a href="{{route('rol.create')}}" class="btn btn-info btn-sm"><li class="fa fa-plus"></li> Agregar Rol</a>
        </div>
    </div>
                    ...
                    <table id="tabla-data" class="table table-bordered">
                        ...
                        @foreach ($roles as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('rol.destroy', ['id' => $item->id])}}" class="form-eliminar" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-system btn-sm" onclick="location.href='{{route('rol.edit', ['id' => $item->id])}}'">
