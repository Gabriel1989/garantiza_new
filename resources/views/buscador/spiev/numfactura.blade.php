...
<div class="panel panel-info panel-border top">
    <div class="panel-heading">
        <span class="panel-title">Buscador de solicitudes por N° Factura</span>
    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="num_factura" id="num_factura">
                    </div>
                    <div class="form-group">
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on("submit","#formBusqueda",function(e){
            ...
            $.ajax({
                url: "{{ route('buscador.spiev.numfactura.form') }}",
                type: "post",
                processData: false,
                contentType: false,
                data: formData,
